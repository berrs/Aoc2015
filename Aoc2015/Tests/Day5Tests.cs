...
namespace Aoc2015.Tests.Day5Tests
{
    public class Day5aTests : TestBase
    {
        public Day5aTests(ITestOutputHelper output) : base(output) { }
        ...
        {
            Day5.A.Calculate(input).ShouldEqual(expected);
        }
        ...
        public void Timing()
        {
            ...
            Enumerable.Range(1, 1000).ForEach(_ => inputs.Count(Day5.A.Calculate)); // 0.27 seconds
    ...
    public class Day5bTests : TestBase
    {
        ...
        public void Timing()
        {
            string[] inputs = Input.A.Tokenize().ToArray();
            var sw = Stopwatch.StartNew();
            Enumerable.Range(1, 1000).ForEach(_ => inputs.Count(Day5.B.Calculate)); // 3 seconds
            WriteLine(sw.Elapsed);
        }
    }
    ...
    static class Input
    {
        public const string A = @"uxcplgxnkwbdwhrp
suerykeptdsutidb
dmrtgdkaimrrwmej
ztxhjwllrckhakut
gdnzurjbbwmgayrg
