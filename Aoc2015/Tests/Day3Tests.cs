...
namespace Aoc2015.Tests.Day3Tests
{
    public class Day3aTests : TestBase
    {
        public Day3aTests(ITestOutputHelper output) : base(output) { }
        ...
        {
            Day3.A.Calculate(input).ShouldEqual(expected);
        }

        [Fact]
        public void Run()
        {
            int v = Day3.A.Calculate(Input.A);
            WriteLine(v);
        }
    }
